...
{
    public class SlidingTabNavStrip : LinearLayout
    {
        ...
        public SlidingTabNavStrip(Context context) : this(context, null)
        { }

        public SlidingTabNavStrip(Context context, IAttributeSet attrs) : base(context, attrs)
        {
